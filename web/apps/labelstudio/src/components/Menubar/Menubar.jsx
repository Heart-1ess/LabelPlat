          ...
          <Dropdown.Trigger
            ...
            content={
              <Menu>
                ...
                <Menu.Item icon={<IconDoor />} label="登出" href={absoluteURL("/logout")} data-external />
                {showNewsletterDot && (
                  <>
                    <Menu.Divider />
                    <Menu.Item className={cn("newsletter-menu-item")} href={pages.AccountSettingsPage.path}>
                      <span>请在“帐户和设置”页面中检查新的通知设置</span>
            ...
            >
              <Menu>
                ...
                <Menu.Item
                  ...
                  target="_blank"
                />
                <Menu.Item label="文档" href="#" icon={<IconBook />} target="_blank" />
