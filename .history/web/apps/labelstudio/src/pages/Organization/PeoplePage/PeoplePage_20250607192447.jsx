  ...
  return (
    <Block name="invite">
      ...
      <Description style={{ marginTop: 16 }}>
          邀请其他人加入您的实例。您邀请的人将拥有您所有项目的完全访问权限。
        <a
    ...
    <Block name="people">
      <Elem name="controls">
        <Space spread>
          ...
          <Space>
            {isFF(FF_AUTH_TOKENS) && <Button onClick={showApiTokenSettingsModal}>API 令牌设置</Button>}
